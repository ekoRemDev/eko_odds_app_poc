...
class ChainsApiService implements IApiService<dynamic> {
  factory ChainsApiService() => _instance;

  ChainsApiService._internal();

  static final _instance = ChainsApiService._internal();
